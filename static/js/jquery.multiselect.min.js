	...
	$.widget("ech.multiselect", {
		...
		_create: function() {
			...
			var button = (this.button = $('<button type="button"><span class="ui-icon ui-icon-triangle-1-s"></span></button>')).addClass("ui-multiselect ui-widget ui-state-default ui-corner-all").addClass(o.classes).attr({
				...
				menu = (this.menu = $("<div />")).addClass("ui-multiselect-menu ui-widget ui-widget-content ui-corner-all").addClass(o.classes).appendTo($(o.appendTo)),
			...
			el.find("option").each(function(i) {
				...
				if(parent.tagName === "OPTGROUP") {
					...
					if($.inArray(optLabel, optgroups) === -1) {
						var optLabelEscaped = optLabel.replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/'/g, "&#39;").replace(/\//g, "&#x2F;").replace(/"/g, "&quot;");
